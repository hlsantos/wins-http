...
(function($) {
  ...
  $.fn.cluetip = function(options) {
    ...
    var defaults = {
      ...
      arrows: true, // false, // CHANGE THIS TO true IF YOU WANT jTip-STYLE ARROWS FOR ALL clueTips
      dropShadow: true,
      dropShadowSteps: 6,
      hoverIntent: true,
      ...
      //-----------------------
      // HLS - return FALSE to cancel activation
    ...
    return this.each(function() {
      ...
      var tagTitle = $this.attr('title'); // .hls1 fixes default tip title
      if (!tipTitle) tipTitle = tagTitle; // .hls1 fixes default tip title
...
// position clueTip horizontally
      ...
      //console.log("arrow posX: ",posX, " | mouseXY: ",mouseX," , ",mouseY);
...
// close cluetip and reset title attribute if one exists
    var cluetipClose = function() {
      ...
      .children().empty();
      //-------------------
      // .hls1 fixes default tip title
      if (tagTitle) {
        $this.attr('title', tagTitle);
      }
      //if (tipTitle) {
