/*
   ...
   Santronics Software, Inc. Modifications:
   452.1 02/06/07
   - hardcoded path to the SWF file
   - debug mode is false
   453.3p 01/22/10
   - added http protocol
   454.4 05/12/12
   - changed swf url to /public/js/soundmanager2.swf
*/

function SoundManager(smURL,smID) {
  var self = this;
  this.version = 'V2.0b.20070123';
  this.url = (smURL||'/public/js/soundmanager2.swf');

  // HLS 01/26/07 03:58 am - set to false
  ...
  this._createMovie = function(smID,smURL) {
    ...
    // 453.3p - added http protocol
    var html = ['<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="'+window.location.protocol+'//fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="16" height="16" id="'+smID+'"><param name="movie" value="'+smURL+'"><param name="quality" value="high"><param name="allowScriptAccess" value="always" /></object>',
                '<embed name="'+smID+'-embed" id="'+smID+'-embed" src="'+smURL+'" width="1" height="1" quality="high" allowScriptAccess="always" pluginspage="'+window.location.protocol+'//www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>'];
